...
Currently rumble support is not added into the framework. It will come at a later time, but multiple cores do have the support built into them, ready for when it is added.
